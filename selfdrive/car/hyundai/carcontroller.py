...
def process_hud_alert(enabled, button_on, fingerprint, visual_alert, left_line,
  ...
  if visual_alert == VisualAlert.steerRequired:
    hud_alert = 4 if fingerprint in [CAR.GENESIS , CAR.GENESIS_G80, CAR.GENESIS_G90] else 3
  ...
  if left_lane_depart:
    left_lane_warning = 1 if fingerprint in [CAR.GENESIS , CAR.GENESIS_G80, CAR.GENESIS_G90] else 2
  if right_lane_depart:
    right_lane_warning = 1 if fingerprint in [CAR.GENESIS , CAR.GENESIS_G80, CAR.GENESIS_G90] else 2
